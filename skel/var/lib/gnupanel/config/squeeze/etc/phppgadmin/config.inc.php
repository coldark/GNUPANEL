<?php
	...
	$conf['servers'][0]['pg_dump_path'] = '/usr/share/phppgadmin/bin/pg_dump';
	$conf['servers'][0]['pg_dumpall_path'] = '/usr/share/phppgadmin/bin/pg_dumpall';
