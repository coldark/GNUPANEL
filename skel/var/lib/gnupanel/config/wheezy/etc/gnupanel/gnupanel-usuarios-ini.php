...
$usuario_db_my = "root";
$passwd_db_my = "MYSQL_PASSWD";
$tema_default_config = "gnutransfer";

if(file_exists("config/gnupanel-plugins-usuarios-ini.php")) require("config/gnupanel-plugins-usuarios-ini.php");

if(file_exists("config/session-pg.php")) require("config/session-pg.php");
