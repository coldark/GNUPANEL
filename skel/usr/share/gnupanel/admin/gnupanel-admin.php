...
***********************************************************************************************************/
error_reporting(0);
require_once("config/gnupanel-admin-ini.php");
session_cache_limiter('nocache');
$session_ant = session_name('admin');
require_once("funciones/funciones.php");

session_start();

if(isset($_SESSION['id_admin'])) $tiempo_max_sesion = dame_tiempo_max_sesion_admin($_SESSION['id_admin']);

session_start();

$idioma_default = "en";
if(isset($_SESSION['id_admin'])) $idioma_default = dame_idioma_admin($_SESSION['id_admin']);
...
$incluye_seccion = "1";
$incluye_plugin = "1";
//$estilo_ini = dame_tema_interfaz_admin();
$estilo_per = dame_tema_interfaz_admin_per();
...
if($logueado == "1")
{
	print "<h4><a href=\"gnupanel-admin.php\" > \n";
	print $escribir['inicio'];
	print "</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;\n";
	print "<a href=\"gnupanel-admin.php&#063;desloguear=1\" > \n";
...
{
	print "<div id=\"contenedor\" > \n";
	$cant_max_result = dame_cant_max_result_admin($_SESSION['id_admin']);
