...
function cuentadigital_configurado()
{
    ...
    $consulta = "SELECT * FROM cuentadigital_admin WHERE id_admin = $id_admin ";
...
function configura_cuentadigital($id_cuentadigital,$active_in)
{
	...
	{
	$consulta = "UPDATE cuentadigital_admin SET id_cuentadigital = '$id_cuentadigital',active = $active WHERE id_admin = $id_admin ";
	$res_consulta = pg_query($conexion,$consulta);
	$checkeo = $res_consulta;
	}
    else
	{
	$consulta = "INSERT INTO cuentadigital_admin(id_admin,id_cuentadigital,active) VALUES($id_admin,'$id_cuentadigital',$active) ";
	$res_consulta = pg_query($conexion,$consulta);
	$checkeo = $res_consulta;
	}
