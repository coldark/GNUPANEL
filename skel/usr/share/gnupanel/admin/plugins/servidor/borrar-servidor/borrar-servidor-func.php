...
function borra_servidor($servidor)
{
    global $servidor_db;
    global $puerto_db;
    global $database;
    ...
    $consulta = "DELETE from gnupanel_servidores WHERE servidor = '$servidor' ";
...
function borrar_servidor_2($procesador,$mensaje)
{
	global $idioma;
	global $escribir;
	global $plugin;
...
function borrar_servidor_1($procesador,$mensaje)
{
	global $idioma;
	global $escribir;
	global $plugin;
...
function borrar_servidor_0($procesador,$mensaje)
{
	global $idioma;
	global $escribir;
	global $plugin;
...
function borrar_servidor_init($nombre_script)
{
	global $_POST;
	...
	{
		case "1":
		borrar_servidor_1($nombre_script,NULL);
		break;
		case "2":
		borrar_servidor_2($nombre_script,NULL);
		break;
		default:
		borrar_servidor_0($nombre_script,NULL);
	}
}
