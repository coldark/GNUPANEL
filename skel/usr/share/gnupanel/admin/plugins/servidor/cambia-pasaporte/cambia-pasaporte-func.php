...
function cambia_pasaporte_id_admin($id_admin,$pasaporte_nuevo)
    {
    global $servidor_db;
    global $puerto_db;
    global $database;
    ...
    $consulta = "UPDATE gnupanel_admin SET pasaporte='$pasaporte_crypt' WHERE id_admin=$id_admin ";
    // AND pasaporte='$pasaporte_viejo' ";
...
function checkea_cambia_pasaporte($pasaporte_actual,$pasaporte_nuevo_0,$pasaporte_nuevo_1)
{
	...
	if(!checkea_pasaporte_id_admin(pg_escape_string($_SESSION['id_admin']),pg_escape_string($pasaporte_actual))) return "mal_contr";
...
function cambia_pasaporte_1($procesador,$mensaje)
{
	...
	{
	print "<div id=\"formulario\" > \n";
		if(cambia_pasaporte_id_admin($id_admin,$pass_nuevo_0))
		{
