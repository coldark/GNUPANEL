...
function listar_ip_0($procesador,$mensaje)
{
	global $idioma;
	global $escribir;
	global $plugin;
	...
	$variables['servidor'] = dame_servidor($arreglo['id_servidor']);
...
function listar_ip_1($nombre_script,$mensaje)
{
	global $idioma;
	global $escribir;
	global $plugin;
...
function listar_ip_init($nombre_script)
{
	global $_POST;
	...
	{
		case "1":
		listar_ip_1($nombre_script,NULL);
		break;
		default:
		listar_ip_0($nombre_script,NULL);
	}
}
