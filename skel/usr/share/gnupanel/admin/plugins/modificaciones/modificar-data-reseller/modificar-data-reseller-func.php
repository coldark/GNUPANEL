...
function verifica_modificar_data_reseller($primer_nombre,$segundo_nombre,$apellido,$compania,$pais,$provincia,$ciudad,$calle,$numero,$piso,$departamento,$codpostal,$telefono,$telefono_celular,$fax)
{
    global $escribir;
	$retorno = NULL;
...
function modificar_data_reseller($id_reseller,$primer_nombre,$segundo_nombre,$apellido,$compania,$pais,$provincia,$ciudad,$calle,$numero,$piso,$departamento,$codpostal,$telefono,$telefono_celular,$fax)
{
global $servidor_db;
global $puerto_db;
global $database;
...
function modificar_data_reseller_0($procesador,$mensaje)
{
	global $idioma;
	global $escribir;
	global $plugin;
...
function modificar_data_reseller_1($nombre_script,$mensaje)
{
	global $idioma;
	global $escribir;
	global $plugin;
...
function modificar_data_reseller_2($nombre_script,$mensaje)
{
	global $idioma;
	global $escribir;
	global $plugin;
	...
	$checkeo = NULL;
	$comienzo = $_POST['comienzo'];
	$checkeo = verifica_modificar_data_reseller($primer_nombre,$segundo_nombre,$apellido,$compania,$pais,$provincia,$ciudad,$calle,$numero,$piso,$departamento,$codpostal,$telefono,$telefono_celular,$fax);

	if($checkeo)
	{
	modificar_data_reseller_1($nombre_script,$checkeo);
	}
	else
	{
	$escriba = NULL;
	if(modificar_data_reseller($id_reseller,$primer_nombre,$segundo_nombre,$apellido,$compania,$pais,$provincia,$ciudad,$calle,$numero,$piso,$departamento,$codpostal,$telefono,$telefono_celular,$fax))
	{
...
function modificar_data_reseller_init($nombre_script)
{
	global $_POST;
	...
	{
		case "1":
		modificar_data_reseller_1($nombre_script,NULL);
		break;
		case "2":
		modificar_data_reseller_2($nombre_script,NULL);
		break;
		default:
		modificar_data_reseller_0($nombre_script,NULL);
	}
}
