...
function enviar_ticket($asunto,$consultar_in)
{
    ...
    $consulta = "SELECT max(id_ticket) FROM gnupanel_tickets_reseller WHERE id_reseller = $id_reseller AND id_cliente_de = $id_admin ";
    ...
    $consulta = "INSERT INTO gnupanel_tickets_reseller(id_ticket,id_reseller,id_cliente_de,asunto,texto_p,conforme) VALUES($id_ticket,$id_reseller,$id_admin,'$asunto','$consultar',0) ";
    $res_consulta = pg_query($conexion,$consulta);
    $checkeo = $res_consulta;
	...
	print "<tr>\n";
	print "<td>\n";
	$escriba = $escribir['consulta'];
	print "$escriba $consultar_in <br>\n";
	print "</td>\n";
	print "</tr>\n";
	print "</table> \n";
	print "</ins> \n";
