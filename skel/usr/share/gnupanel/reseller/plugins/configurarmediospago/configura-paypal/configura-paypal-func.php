...
function paypal_configurado()
{
    ...
    $consulta = "SELECT * FROM paypal_reseller WHERE id_reseller = $id_reseller ";
...
function configura_paypal($correo_paypal,$test_in,$active_in)
{
	...
	{
	$consulta = "UPDATE paypal_reseller SET correo_paypal = '$correo_paypal',test = $test,active = $active WHERE id_reseller = $id_reseller ";
	$res_consulta = pg_query($conexion,$consulta);
	$checkeo = $res_consulta;
	}
    else
	{
	$consulta = "INSERT INTO paypal_reseller(id_reseller,correo_paypal,test,active) VALUES($id_reseller,'$correo_paypal',$test,$active) ";
	$res_consulta = pg_query($conexion,$consulta);
	$checkeo = $res_consulta;
	}
