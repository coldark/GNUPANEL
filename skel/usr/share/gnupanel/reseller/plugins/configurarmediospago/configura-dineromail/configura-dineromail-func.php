...
function dineromail_configurado()
{
    ...
    $consulta = "SELECT * FROM dineromail_reseller WHERE id_reseller = $id_reseller ";
...
function configura_dineromail($id_dineromail,$active_in)
{
	...
	{
	$consulta = "UPDATE dineromail_reseller SET id_dineromail = '$id_dineromail',active = $active WHERE id_reseller = $id_reseller ";
	$res_consulta = pg_query($conexion,$consulta);
	$checkeo = $res_consulta;
	}
    else
	{
	$consulta = "INSERT INTO dineromail_reseller(id_reseller,id_dineromail,active) VALUES($id_reseller,'$id_dineromail',$active) ";
	$res_consulta = pg_query($conexion,$consulta);
	$checkeo = $res_consulta;
	}
