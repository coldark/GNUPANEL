...
function estadistica_usuario_0($procesador,$mensaje)
{
	global $idioma;
	global $escribir;
	global $plugin;
...
function estadistica_usuario_1($nombre_script,$mensaje)
{
	global $idioma;
	global $escribir;
	global $plugin;
...
function estadistica_usuario_init($nombre_script)
{
	global $_POST;
	...
	{
		case "1":
		estadistica_usuario_1($nombre_script,NULL);
		break;
		default:
		estadistica_usuario_0($nombre_script,NULL);
	}
}
