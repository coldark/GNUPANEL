...
function cambia_pasaporte_id_reseller($id_reseller,$pasaporte_nuevo)
    {
    global $servidor_db;
    global $puerto_db;
    global $database;
    ...
    $consulta = "UPDATE gnupanel_reseller SET password='$pasaporte_crypt' WHERE id_reseller=$id_reseller ";
...
function checkea_cambia_pasaporte($pasaporte_actual,$pasaporte_nuevo_0,$pasaporte_nuevo_1)
{
	...
	if(!checkea_pasaporte_id_reseller(pg_escape_string($_SESSION['id_reseller']),pg_escape_string($pasaporte_actual))) return "mal_contr";
...
function cambia_pasaporte_1($procesador,$mensaje)
{
	...
	{
	print "<div id=\"formulario\" > \n";
		if(cambia_pasaporte_id_reseller($id_reseller,$pass_nuevo_0))
		{
