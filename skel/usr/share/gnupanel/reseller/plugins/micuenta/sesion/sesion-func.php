...
function set_sesion_reseller($id_reseller,$tiempo_max_sesion,$cant_max_result,$tema,$politica_de_suspencion,$dias_de_gracia)
{
    global $servidor_db;
    global $puerto_db;
    global $database;
    ...
    $consulta = "UPDATE gnupanel_reseller_sets SET tiempo_max_sesion = $tiempo_max_sesion, cant_max_result = $cant_max_result,politica_de_suspencion = $politica_de_suspencion, id_tema = (SELECT id_tema from gnupanel_temas WHERE tema = '$tema'), dias_de_gracia = $dias_de_gracia WHERE id_reseller = $id_reseller";
...
function sesion_1($procesador,$mensaje)
{
    ...
    print "<ins> \n";
    $ventosa = set_sesion_reseller($id_reseller,$tiempo_max_sesion,$cant_max_result,$tema,$politica_de_suspencion,$dias_de_gracia);
    if($ventosa)
	{
...
function sesion_0($procesador,$mensaje)
{
	...
	{
	$tiempo_max_sesion = dame_tiempo_max_sesion_reseller($id_reseller);
	}
    else
	{
	...
	{
	$cant_max_result = dame_cant_max_result_reseller($id_reseller);
	}
    else
	{
	...
	{
	$politica_de_suspencion = dame_politica_susp_reseller($id_reseller);
	}
    else
	{
	...
	{
	$dias_de_gracia = dame_dias_de_gracia_reseller($id_reseller);
	}
    else
	{
