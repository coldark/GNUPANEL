...
$session_ant = session_name('reseller');

require_once("funciones/funciones.php");

session_start();

if(isset($_SESSION['id_reseller'])) $tiempo_max_sesion = dame_tiempo_max_sesion_reseller($_SESSION['id_reseller']);

session_start();

$idioma_default = "en";
if(isset($_SESSION['id_reseller'])) $idioma_default = dame_idioma_reseller($_SESSION['id_reseller']);
...
$incluye_seccion = "1";
$incluye_plugin = "1";
//$estilo_ini = dame_tema_interfaz_reseller();
$estilo_per = dame_tema_interfaz_reseller_per();
...
if($logueado == "1")
{
	$escriba = $_SESSION['dominio_r'];
	print "<h2>$escriba</h2>\n";
	print "<h4><a href=\"gnupanel-reseller.php\" > \n";
	print $escribir['inicio'];
	print "</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;\n";
	print "<a href=\"gnupanel-reseller.php&#063;desloguear=1\" > \n";
...
{
	print "<div id=\"contenedor\" > \n";
	$cant_max_result = dame_cant_max_result_reseller($_SESSION['id_reseller']);
