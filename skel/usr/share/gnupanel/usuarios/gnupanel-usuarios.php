...
if($logueado == "1")
{
	$escriba = $_SESSION['dominio'];
	print "<h2>$escriba</h2>\n";
	print "<h4><a href=\"gnupanel-usuarios.php\" > \n";
	print $escribir['inicio'];
	print "</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;\n";
	print "<a href=\"gnupanel-usuarios.php&#063;desloguear=1\" > \n";
