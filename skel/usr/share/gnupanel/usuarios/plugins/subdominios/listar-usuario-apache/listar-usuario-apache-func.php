...
function listar_usuario_apache_0($procesador,$mensaje)
{
	global $idioma;
	global $escribir;
	global $plugin;
...
function listar_usuario_apache_init($nombre_script)
{
	global $_POST;
	...
	{
		case "1":
		listar_usuario_apache_1($nombre_script,NULL);
		break;

		case "2":
		listar_usuario_apache_2($nombre_script,NULL);
		break;

		default:
		listar_usuario_apache_0($nombre_script,NULL);
	}
}
