...
function lista_pagos_realizados($comienzo)
    ...
    $consulta = "SELECT id,importe,inicio_pago,acreditacion_pago,empresa_cobranza,codigo_seguimiento,confirmado,acreditado FROM pagos_usuario WHERE id_usuario = $id_usuario ORDER BY id DESC LIMIT $cant_max_result OFFSET $comienzo";
...
function cantidad_pagos_realizados()
    ...
    $consulta = "SELECT id,importe,inicio_pago,acreditacion_pago,empresa_cobranza,codigo_seguimiento FROM pagos_usuario WHERE id_usuario = $id_usuario ";
