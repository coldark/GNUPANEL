...
function dame_plan_usuario($id_usuario)
    {
    global $servidor_db;
    global $puerto_db;
    global $database;
    ...
    $consulta = "SELECT * FROM gnupanel_usuario_plan WHERE id_usuario = $id_usuario";
	...
	{
		if($llave!='id_usuario' && $llave!='id_plan')
		{
...
function mi_plan_0($nombre_script,$mensaje)
{
	...
	$mi_plan = dame_plan_usuario($id_usuario);
