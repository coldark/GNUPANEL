...
function dame_data_usuario($id_usuario)
    ...
    $consulta = "SELECT correo_contacto FROM gnupanel_usuario WHERE id_usuario = $id_usuario";
    $res_consulta = pg_query($conexion,$consulta);
...
function modificar_misdatos($id_usuario,$primer_nombre,$segundo_nombre,$apellido,$correo_contacto,$compania,$pais,$provincia,$ciudad,$calle,$numero,$piso,$departamento,$codpostal,$telefono,$telefono_celular,$fax)
{
global $servidor_db;
global $puerto_db;
global $database;
...
$consulta_2 = "UPDATE gnupanel_usuario SET correo_contacto = '$correo_contacto' WHERE id_usuario = $id_usuario ";
...
function modificar_misdatos_0($nombre_script,$mensaje)
{
	...
	if(es_usuario_principal($id_usuario))
	{
	print "<div id=\"formulario\" > \n";
	$escriba = $escribir['es_principal'];
	print "<br><br><em>$escriba</em> <br> \n";
	print "</div> \n";
...
function modificar_misdatos_2($nombre_script,$mensaje)
{
	global $idioma;
	global $escribir;
	global $plugin;
	...
	if($checkeo)
	{
	modificar_misdatos_1($nombre_script,$checkeo);
	}
	else
	{
	$escriba = NULL;
	if(modificar_misdatos($id_usuario,$primer_nombre,$segundo_nombre,$apellido,$correo_contacto,$compania,$pais,$provincia,$ciudad,$calle,$numero,$piso,$departamento,$codpostal,$telefono,$telefono_celular,$fax))
	{
...
function modificar_misdatos_init($nombre_script)
{
	...
	{
		case "2":
		modificar_misdatos_2($nombre_script,NULL);
		break;
		case "1":
		modificar_misdatos_1($nombre_script,NULL);
		break;
