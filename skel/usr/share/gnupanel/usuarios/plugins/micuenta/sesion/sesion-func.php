...
function set_sesion_usuario($id_usuario,$tiempo_max_sesion,$cant_max_result,$tema)
{
    global $servidor_db;
    global $puerto_db;
    global $database;
...
function sesion_1($procesador,$mensaje)
{
    ...
    $tema = $_POST['tema'];
    if( verifica_dato($tiempo_max_sesion,true) && verifica_dato($cant_max_result,true) && $tiempo_max_sesion>0 && $cant_max_result>0)
    {
    print "<div id=\"formulario\" > \n";
    print "<ins> \n";
    $ventosa = set_sesion_usuario($id_usuario,$tiempo_max_sesion,$cant_max_result,$tema);
    if($ventosa)
	{
...
function sesion_0($procesador,$mensaje)
{
    ...
    if(!$_POST['tiempo_max_sesion']) 
	{
	$tiempo_max_sesion = dame_tiempo_max_sesion_usuario($id_usuario);
	}
    else
	{
    ...
    if(!$_POST['cant_max_result'])
	{
	$cant_max_result = dame_cant_max_result_usuario($id_usuario);
	}
    else
	{
